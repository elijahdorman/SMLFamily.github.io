...
<H2><A NAME="section:0"></A>The <CODE>PrimIO</CODE> functor</H2>
<HR>
<H4>Synopsis</H4>
<BLOCKQUOTE>
<CODE><B>functor</B>&nbsp;<A NAME="PrimIO:FCT:SPEC"></A><CODE>PrimIO</CODE><B> (</B> ... <B>)</B><B> : </B>PRIM_IO&nbsp;&nbsp;<FONT COLOR="#FF0000"><CODE><I>(* OPTIONAL *)</I></CODE></FONT><BR>
</CODE>
</BLOCKQUOTE>
<P>
The optional functor <CODE>PrimIO</CODE> builds an instance of the primitive I/O signature <CODE><A HREF="prim-io.html#PRIM_IO:SIG:SPEC">PRIM_IO</A></CODE>. 
<HR>
<H4>Functor argument interface</H4>
<BLOCKQUOTE>
<CODE><B>structure</B>&nbsp;Vector&nbsp;<B>:</B>&nbsp;<A HREF="mono-vector.html#MONO_VECTOR:SIG:SPEC">MONO_VECTOR</A><BR>
<B>structure</B>&nbsp;VectorSlice&nbsp;<B>:</B>&nbsp;<A HREF="mono-vector-slice.html#MONO_VECTOR_SLICE:SIG:SPEC">MONO_VECTOR_SLICE</A><BR>
<B>structure</B>&nbsp;Array&nbsp;<B>:</B>&nbsp;<A HREF="mono-array.html#MONO_ARRAY:SIG:SPEC">MONO_ARRAY</A><BR>
<B>structure</B>&nbsp;ArraySlice&nbsp;<B>:</B>&nbsp;<A HREF="mono-array-slice.html#MONO_ARRAY_SLICE:SIG:SPEC">MONO_ARRAY_SLICE</A><BR>
<B>sharing</B>&nbsp;<B>type</B>&nbsp;Vector.elem&nbsp;=&nbsp;VectorSlice.elem&nbsp;=&nbsp;Array.elem<BR>
&nbsp;&nbsp;=&nbsp;ArraySlice.elem<BR>
<B>sharing</B>&nbsp;<B>type</B>&nbsp;Vector.vector&nbsp;=&nbsp;VectorSlice.vector<BR>
&nbsp;&nbsp;=&nbsp;Array.vector&nbsp;=&nbsp;ArraySlice.vector<BR>
<B>sharing</B>&nbsp;<B>type</B>&nbsp;VectorSlice.slice&nbsp;=&nbsp;ArraySlice.vector_slice<BR>
<B>sharing</B>&nbsp;<B>type</B>&nbsp;Array.array&nbsp;=&nbsp;ArraySlice.array<BR>
<B>val</B>&nbsp;<A NAME="ARG:PrimIO.someElem:VAL:SPEC" HREF="#ARG:PrimIO.someElem:VAL">someElem</A>&nbsp;<B>:</B>&nbsp;Vector.elem<BR>
<B>eqtype</B>&nbsp;<A NAME="ARG:PrimIO.pos:TY:SPEC" HREF="#ARG:PrimIO.pos:TY">pos</A><BR>
<B>val</B>&nbsp;<A NAME="ARG:PrimIO.compare:VAL:SPEC" HREF="#ARG:PrimIO.compare:VAL">compare</A>&nbsp;<B>:</B>&nbsp;pos&nbsp;<B>*</B>&nbsp;pos&nbsp;<B>-&gt;</B>&nbsp;order</CODE>
</BLOCKQUOTE>
<H4>Description</H4>
<DL>
<DT> <A NAME="ARG:PrimIO.someElem:VAL"></A><CODE><B>val</B>&nbsp;someElem&nbsp;<B>:</B>&nbsp;Vector.elem</CODE>
<DD>
          An element that may be read or written by a <CODE><A HREF="prim-io.html#SIG:PRIM_IO.reader:TY:SPEC">reader</A></CODE>  or <CODE><A HREF="prim-io.html#SIG:PRIM_IO.writer:TY:SPEC">writer</A></CODE>.  The value <CODE><A HREF="prim-io-fn.html#ARG:PrimIO.someElem:VAL:SPEC">someElem</A></CODE> is typically used for initialization  of buffers.   
<BR>
<BR>

<DT> <A NAME="ARG:PrimIO.compare:VAL"></A>
<DT> <CODE>compare (<VAR>pos</VAR>, <VAR>pos'</VAR>) </CODE>
<DD>
returns <CODE><A HREF="general.html#SIG:GENERAL.order:TY:SPEC">LESS</A></CODE>, <CODE><A HREF="general.html#SIG:GENERAL.order:TY:SPEC">EQUAL</A></CODE>, or <CODE><A HREF="general.html#SIG:GENERAL.order:TY:SPEC">GREATER</A></CODE>  when <VAR>pos</VAR> is less than, equal to, or greater than  <VAR>pos'</VAR>, respectively, in some underlying linear ordering on <CODE><A HREF="prim-io-fn.html#ARG:PrimIO.pos:TY:SPEC">pos</A></CODE> values.  
<BR>
<BR>
